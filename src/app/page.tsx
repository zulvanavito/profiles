    ...
    <main className="flex flex-col min-h-[100dvh] space-y-10">
      ...
      <section id="about">
        ...
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <Markdown className="prose max-w-full text-pretty font-sans text-md text-muted-foreground dark:prose-invert text-justify">
            {DATA.summary}
          </Markdown>
        </BlurFade>
      </section>
          ...
          {DATA.education.map((education, id) => (
            ...
            >
              <ResumeCard
                ...
                title={education.prodi}
                tipe={education.nilai}
